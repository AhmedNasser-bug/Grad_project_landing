# Task7.2.1-Stripe-Grant-Checkout-Modal-Card

- **Epic:** `Epic7-Partnership-Sponsorship-Payment-Gate`
- **Feature:** `Feature7.2-Screen-Wide-Sponsorship-Matrix-Card`
- **Assigned Skill Suite:** `/waf-security`, `/waf-reliability`, `/teamwork-preview`
...
> **Mandatory Action:** Import Epic 0 card primitives for sponsorship matrix checkout.

## Context & Clinical Objective
Build Card 08 screen-wide sponsorship matrix card and Stripe test checkout modal.
