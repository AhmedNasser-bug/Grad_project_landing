# Task3.2.1-Full-Viewport-Hero-Card-Setup

- **Epic:** `Epic3-Visual-Core-WebGL-Fluid-GSAP`
- **Feature:** `Feature3.2-Screen-Wide-Parallax-Hero-Card`
- **Assigned Skill Suite:** `/frontend-design`, `/web-artifacts-builder`, `/teamwork-preview`
...
> **Mandatory Action:** Import Epic 0 full-bleed WebGL fluid shader module.

## Context & Clinical Objective
Build Card 00 Hero screen-wide parallax card relying strictly on the full-bleed WebGL dialysate clearance shader.
