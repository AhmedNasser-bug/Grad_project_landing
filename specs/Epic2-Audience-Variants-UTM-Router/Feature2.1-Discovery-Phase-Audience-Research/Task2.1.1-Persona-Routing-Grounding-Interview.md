# Task2.1.1-Persona-Routing-Grounding-Interview

- **Epic:** `Epic2-Audience-Variants-UTM-Router`
- **Feature:** `Feature2.1-Discovery-Phase-Audience-Research`
- **Assigned Skill Suite:** `/spec`, `/frontend-design`, `/teamwork-preview`
...
> **Mandatory Action:** Search UTM parameter state management patterns and conduct user interview via ask_question.

## Context & Clinical Objective
Research clinical persona routing UX patterns and interview user on role-tailored hero headlines.
